...
require 'sportradar/api/soccer_v3/team_basic'
...
require 'sportradar/api/soccer_v3/tournament_standings'
require 'sportradar/api/soccer_v3/group'
require 'sportradar/api/soccer_v3/group_standing'
require 'sportradar/api/soccer_v3/team_standing'
