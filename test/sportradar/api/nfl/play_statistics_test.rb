...
class Sportradar::Api::Nfl::PlayStatisticsTest < Minitest::Test
  ...
  def test_nfl_player_initializes
    assert %i[response kick return rush defense receive punt penalty pass first_down field_goal defense down_conversion].all? { |e| @data_object.attributes.include?(e) }
  end
